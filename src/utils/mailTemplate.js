class EmailTemplates {
  static AuthenticationTemplate = (data) => {
    const { firstname, message, showButton } = data;
    return `
    <!DOCTYPE html>
<html
                          ...
                          <tbody>
                            <tr>
                              <td style="width: 510px">
                                <img
                                  height="auto"
                                  src="https://s3-eu-west-1.amazonaws.com/topolio/uploads/63c725d8b2dcf/1673995829.jpg"
                                  style="
                                    border: 0;
                                    display: block;
                                    outline: none;
                          ...
                          <tr>
                            <td
                              ...
                              style="
                                ...
                                border-radius: 3px;
                                cursor: auto;
                                mso-padding-alt: 9px 26px 9px 26px;
                                background: #5fd39d;
                              "
                              valign="middle"
                            >
                      ...
                      >
                        ...
                        >
                          <p
                            ...
                            "
                          >
                            You may ignore this mail if you did not request this
                          </p>
                        </div>
                      </td>
                    </tr>
